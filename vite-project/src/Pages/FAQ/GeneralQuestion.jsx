...
const GeneralQuestion = () => {
    return (
        <div className='container-2xl xs:px-0 md:px-32'>
            ...
            <div className='h-auto  flex xs:flex-wrap lg:flex-nowrap  p-5 '>
                <div className='w-1/4 h-auto pt-12  '>
                    <h1 className='text-black font-bold text-3xl'>Orders<br /> & Shipping</h1>
                </div>
            ...
            <div className='h-auto w-full flex xs:flex-wrap lg:flex-nowrap mt-10 p-5 '>
                <div className='w-1/4 h-auto pt-12 '>
                    <h1 className='text-black font-bold text-3xl'>Returns
                        & Exchanges</h1>
                </div>
            ...
            <div className='h-auto  flex xs:flex-wrap lg:flex-nowrap mt-10 p-5  mb-20'>
                <div className='w-1/4 h-auto pt-12 '>
                    <h1 className='text-black font-bold text-3xl'>Discounts
                    </h1>
                </div>
